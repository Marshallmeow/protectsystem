...
1.  Получение всех сведений о ядре:
...
2.  Получение сведений об используемом дистрибутиве:
...
3.  Получение данных о модели процессора:
...
4.  Получение последних 30 строк системных логов:
...
Таким образом, было проведено ознакомление с базовыми командами ОС
Linux\Debian 11 и интерфейсом программной среды r-studio.
